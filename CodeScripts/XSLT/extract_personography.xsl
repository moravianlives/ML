...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  -->
    ...
    <xsl:template match="/">
        ...
        <!-- , "occupation", "office", "health", "event", "ceremony", "calendar", "when -->
        
        
        <xsl:for-each select="//text//persName">
            
            <!--  | //text//placeName | //text//roleName | //text//orgName | //text//objectName | //text//date | //text//name |//text//occupation |//text//office -->
