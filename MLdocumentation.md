...
A TEI customized schema was developed (last updated in January 2025), which is published as an [ODD file](/CodeScripts/MoravianMemoirs.odd)) and [RNG file](/CodeScripts/out/MoravianMemoirs.rng) in the CodeScripts repository.
